...
## 내재주의(internalism)와 외재주의(externalism)의 함의

### 1. 내재주의(Internalism)를 취할 때의 함의
{: .no_toc }

#### (1) 이유와 동기의 긴밀한 연관
{: .no_toc }

* 이유는 행위자의 **동기 구조 S**(선호, 욕구, 신념 등)에서 **건전하게 숙고하면 나올 수 있는 것**과 연결된다.
* 따라서 어떤 사실 p가 이유가 되려면, A가 그것을 자신의 동기 구조에서 “끌어올려” 실제로 고려하거나 고려할 능력이 있어야 한다.

#### (2) 함의
{: .no_toc }

* **이유의 개인상대성(person-relativity)**: 똑같은 p라도 어떤 행위자에겐 이유가 되고, 다른 사람에겐 이유가 되지 않을 수 있다. 예컨대, 담배의 해로움이 ‘건강을 지키려는 욕구’를 가진 사람에겐 강력한 이유지만, 전혀 신경 쓰지 않는 사람에게는 그렇지 않다.
* **비도덕적 행위자 문제**: 악인이나 무감각한 사람에게 “도덕적 이유”가 아예 존재하지 않을 수 있다. 이는 우리가 갖는 “누구에게나 타인의 고통을 줄여야 할 이유가 있다”는 직관과 충돌한다.
* **규범의 권위 약화 위험**: “너는 그럴 이유가 있어”라는 말이, 실제로 그 사람의 동기 구조에서 건전하게 도출되지 않는다면 공허하게 된다.
* **동기 부여 설명의 강점**: 왜 어떤 이유가 실제 행위에 작용하는지, 또는 전혀 작용하지 않는지를 더 잘 설명해 준다. 즉, “이유”와 “동기 부여” 사이의 간극을 좁힌다.

### 2. 외재주의(Externalism)를 취할 때의 함의
{: .no_toc }

#### (1) 이유의 행위자 독립성
{: .no_toc }

* 어떤 사실 p가 A에게 이유인지는, A의 현재 동기 구조와 무관하게 결정된다.
* 예: “고통을 주지 않을 이유”는 설령 그가 타인의 고통에 전혀 무심하더라도 **그에게 여전히 존재**한다.

#### (2) 함의
{: .no_toc }

* **이유의 보편성(universality)**: 도덕적·실천적 이유는 모든 행위자에게 동일하게 적용된다.
* **도덕적 비난의 기반 강화**: 악인이나 무감각한 사람도 ‘그럴 이유가 있었지만 무시했다’고 말할 수 있으므로, 비난 가능성과 도덕적 책임을 더 잘 설명한다.
* **동기와 이유의 분리**: 이유가 있음에도 불구하고 전혀 동기가 없을 수 있다. 따라서 “이유가 있는데도 왜 안 했는가?”라는 질문이 자연스러워진다.
* **행위자 무관적 규범성(objectivity of normativity)**: 규범적 명령(“너는 해야 한다”)이 행위자의 심리적 조건과 무관하게 강한 구속력을 가질 수 있다.
* 단점은, **이유의 동기 부여력**을 설명하기가 어렵다는 점이다. 즉 “이유가 있는데 왜 전혀 움직이지 않는가?”에 답하기 힘들다.
...
| 구분     | 내재주의              | 외재주의            |
| ------ | ----------------- | --------------- |
| 이유의 성격 | 행위자 S(동기구조)와 연동   | 행위자와 무관, 객관적    |
| 도덕적 이유 | 악인에겐 아예 부재할 수도    | 누구에게나 항상 존재     |
| 규범의 권위 | 행위자의 숙고 능력에 의존    | 객관적·보편적, 행위자 무관 |
| 동기 설명  | 이유 ↔ 동기 연결이 밀접    | 이유와 동기 사이에 간극   |
| 비난 가능성 | 제한적(“그에겐 이유 없었다”) | 강화(“있었지만 무시했다”) |
| 위험/약점  | 규범적 직관 약화         | 동기 부여 설명 약화     |

### 4. 함의의 철학적 쟁점
{: .no_toc }

* **도덕적 권위 vs. 심리적 설명**: 외재주의는 도덕적 이유의 보편성과 규범적 권위를 살리지만, 내재주의는 동기 부여와 실천적 설명의 설득력을 살린다.
* **정의론·법철학적 맥락**: 내재주의를 택하면 “법적·도덕적 규범이 왜 나를 구속하는가?”를 행위자의 심리적 구조와 연계해 설명해야 하며, 외재주의를 택하면 “규범은 그 자체로 구속력을 가진다”는 방향으로 나아간다.

👉 정리하면:

* **내재주의** = 이유는 행위자 내적 동기 구조와 연결 → 설명력은 강하지만 규범적 권위 약화 위험.
* **외재주의** = 이유는 행위자와 무관하게 객관적 → 규범적 권위는 강하지만 동기적 설명이 약화.
...
* **Soldier 사례**: ‘적의 인간성’(p)은 참이지만 전투 중엔 이를 **생각하지 않는 편이 더 잘 싸운다**. 그렇다면 건전하게 p를 숙고·동기화하는 것이 오히려 비합리적이니 DC가 깨지는 것 아닌가(마르코비츠).
...
* **(2C)\~(2C\*)** 그 능력의 내막은 “A의 실제 S에 있는 **우발적 동기** + (건전한/건전하지 않은 포함) **도구적 숙고**”로 분석된다(완화된 Humean 동기 이론). 
* **귀결 (3C\*)**: p가 **정당화적** 이유이려면, A의 S에서 **건전한** 도구적 숙고를 **A가 실제로 거칠 능력**이 있어야 한다(수정된 W-INT).

T2. **DC(숙고 제약)는 유지**되어야 한다(EC와 독립적으로도 설득력 있음)

* DC: “p가 이유이면, (해당 상황 C에서) **건전한 숙고 경로**를 통해 **p 때문에** Φ하도록 이끄는 길이 있어야 한다.”
* 단, DC는 **완전덕성**이 아니라, **실제 A의 결점들을 고정**한 채 그 안에서 가능한 최선의 숙고 **경로 단위**로 인덱싱해야 한다(조건적 오류 회피).

T3. **RC-INT(합리적 능력/이유 내재주의)**—개괄적 정식화

* p가 이유라면, A는 **p까지 건전하게 숙고하여 Φ 결론에 도달할 현재 능력**을 가져야 한다.
...
* 동기적 능력 자체는 **건전하지 않은 숙고**로도 발휘되지만(2C\*), **정당화적 이유**는 **건전한 숙고**에 의해 색인되므로(DC) 결과적으로 **건전한 숙고 능력**이 요구된다.
...
* **Soldier**: 인간성(p)은 **전쟁 참여 결정**의 이유로는 작동하지만, **전술행위 선택**에는 (일정 조건하에) 비관련적일 수 있다. 관련적일 때에는 전투 중에도 p를 고려·작동시키는 것이 **건전한 숙고의 사례**다. “겁먹을 수 있다”는 사실은 그 경로가 **건전하지** 않음을 뜻하지 않는다.
...
2. **규범적 권위(정당명령) 논변**: **결정적 이유**가 있으면 A는 **진정한 요구**(authoritative demand) 하에 **하여야만** 한다. 이런 요구가 성립하려면, A가 그 요구를 **합리적으로 충족할 수 있으리라 기대할 수 있는 어떤 숙고적 조건 X**이 가능해야 한다. 이 X의 최적 후보가 바로 **이유사실을 고려·그에 의해 움직이게 하는 건전한 숙고**다. 그러므로 DC는 **정당명령 가능성의 조건**이다.
