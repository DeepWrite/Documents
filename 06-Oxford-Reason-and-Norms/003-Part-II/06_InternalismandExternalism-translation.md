...
## **(p. 149) 6.3 EC, 윌리엄스의 내재주의, 그리고 심사적 제약(Deliberative Constraint)**

만약 EC가 이유(reason)에 관한 모든 추가적인 이론화를 제약한다고 하는 윌리엄스의 주장이 옳다면, EC가 가하는 제약을 어떻게 가장 잘 이해할 수 있을까? 그리고 그것이 어떻게 윌리엄스가 제시한 것과 같은 좀 더 구체화된 내재주의적 논제를 지지할 수 있을까? 6.1절에서 EC와 윌리엄스가 자신의 내재주의적 견해를 진술한 부분을 다시 상기해 보자.
